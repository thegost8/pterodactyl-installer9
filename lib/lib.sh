...
#                                                                                    #
# https://github.com/thegost8/pterodactyl-installer9/blob/master/LICENSE #
#                                                                                    #
# This script is not associated with the official Pterodactyl Project.               #
# https://github.com/thegost8/pterodactyl-installer9                     #
#                                                                                    #
######################################################################################
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/thegost8/pterodactyl-installer9"}
...
welcome() {
  ...
  output "https://github.com/thegost8/pterodactyl-installer9"
  output ""
